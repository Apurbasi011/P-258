...
left_frame = Frame(root, bd = 5, bg = 'yellow', padx = 10, pady = 10)
Label(left_frame, text = "Enter Username", bg = 'purple').grid(row = 0, column = 0, sticky = W, pady = 15)
Label(left_frame, text = "Enter Password", bg = 'purple').grid(row = 1, column = 0, sticky = W, pady = 15)
...
def openNewWindow():
    ...
    if user_name == 'myaccount' and user_pass == '123456':
...
login_btn = Button(left_frame, width = 10, text = "Login", cursor = 'hand2', command = openNewWindow)
